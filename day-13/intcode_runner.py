...
def intcode_runner(program, inputs=None, pointer=0, return_on_output=0, return_on_input=False, relative_base=0, verbal=False):
    if inputs is None:
        inputs = []
    ...
    while True:
        ...
        if opcode == 1:
            ...
            if return_on_input:
                return [False, outputs, program, pointer, relative_base]
            try:
